...
def SAXS():
    return [
        [
            ...
            {"motor": slits2.vcenter, "position": -0.66, "order": 0},
            {"motor": slits2.hsize, "position": 0.35, "order": 0},
            {"motor": slits2.hcenter, "position": -0.24, "order": 0},
...
def SAXS_liquid():
    return [
        [
            ...
            {"motor": slits1.hcenter, "position": -0.18, "order": 0},
            {"motor": slits2.vsize, "position": 0.5, "order": 0},
            {"motor": slits2.vcenter, "position": -0.66, "order": 0},
            {"motor": slits2.hsize, "position": 0.7, "order": 0},
            {"motor": slits2.hcenter, "position": -0.24, "order": 0},
            {"motor": slits3.vsize, "position": 2.5, "order": 0},
            {"motor": slits3.vcenter, "position": -0.22, "order": 0},
            {"motor": slits3.hsize, "position": 2.5, "order": 0},
            {"motor": slits3.hcenter, "position": -0.06, "order": 0},
            {"motor": Shutter_Y, "position": 2.2, "order": 0},
